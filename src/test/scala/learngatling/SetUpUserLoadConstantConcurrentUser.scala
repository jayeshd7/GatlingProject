...
class SetUpUserLoadConstantConcurrentUser extends Simulation{
...
/*
  setUp(
    scenario1.inject(atOnceUsers(1),rampUsers(5) during (10 seconds), constantConcurrentUsers(6) during(60 seconds)),
    scenario2.inject(atOnceUsers(1))
  ).protocols(httpProtocol)*/
/*
setUp(
    scenario1.inject(rampConcurrentUsers(0) to (6) during(20 seconds),constantConcurrentUsers(6) during(60 seconds)),
    scenario2.inject(rampConcurrentUsers(0) to (4) during(20 seconds),constantConcurrentUsers(4) during(60 seconds))
    .protocols(httpProtocol))*/
 setUp(
    scenario1.inject(constantConcurrentUsers(2) during(60 seconds)),
    scenario2.inject(constantConcurrentUsers(2) during(60 seconds))
      .protocols(httpProtocol))
